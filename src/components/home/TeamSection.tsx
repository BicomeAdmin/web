                ...
                <div ref={cta.ref} className={`relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 p-8 md:p-12 text-center ${cta.visible ? 'reveal-in' : 'reveal-init'}`}>
                    ...
                    <div className="relative">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-3 px-10 py-4 bg-white text-emerald-600 font-display font-black rounded-xl hover:bg-emerald-50 transition-shadow hover:shadow-2xl shadow-xl will-change-transform"
                        >
