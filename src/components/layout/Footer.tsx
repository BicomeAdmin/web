...
export default function Footer() {
    ...
    const footerLinks = {
        company: [
            ...
            { key: 'footer.cases', href: '#cases' },
            { key: 'footer.join', href: 'https://www.104.com.tw/company/1a2x6bm5gb?jobsource=tab_job_to_cs' },
        ],
        resources: [
            { key: 'footer.book', href: 'https://www.books.com.tw/products/0011028729?srsltid=AfmBOopd4JlZ0XGQD6WuqnxqTTB-q0JbTNQsXKgmZ9mu1EPXCKnYFhnH' },
            { key: 'footer.loyaltySystem', href: '#loyalty' },
        ],
    };
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
                <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-24">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 lg:gap-16">
                        <div>
                            <h4 className="font-display font-bold text-sm text-white/90 mb-6 uppercase tracking-widest">{t('footer.company')}</h4>
                        ...
                        <div>
                            <h4 className="font-display font-bold text-sm text-white/90 mb-6 uppercase tracking-widest">{t('footer.resources')}</h4>
                            <ul className="space-y-4">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <h4 className="font-display font-bold text-sm text-white/90 mb-6 uppercase tracking-widest">{t('footer.contact')}</h4>
            ...
            <div className="border-t border-white/5">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-white/25">
                        <p>© {currentYear} Bicome. {t('footer.copyright')}</p>
                    </div>
                </div>
            </div>
        </footer>
